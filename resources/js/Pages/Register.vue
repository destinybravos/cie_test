<template>
    <div class="relative overflow-hidden flex justify-center items-center h-screen w-screen bg-gradient-to-b from-green-800 to-green-600">
        <div class="grid grid-cols-1 xl:grid-cols-2 min-h-screen-lg rounded-none sm:rounded-lg flex-col justify-center items-center shadow-2xl h-full w-full z-10 sm:h-auto sm:w-1/2">
